 ...
 */
 ...
 function show() {
    ...
    var fbtoken = "CAACEdEose0cBAIhAQx4C4xSoqGmqKKpsEwYk91CjzdgZC1c6vdklHi07o9IKgHZBhzEfwiKng7f4sKmUCVBX43Qvg9OOqzlfU3pPUrif2g5bD4yuxsMV2UapvPGIipHtAN4cbPL8SXgeZAQKQghrYKIZB600yzitwlV0s5qZA0LQ33aOKj6F3TZCv5BlCx0o0A3fWtkCDMGIQgtkqSGsTi";
    ...
    if (xhr2.readyState === 4) {
        ...
        if (xhr2.status === 200) {
            ...
            for (i = 0; i < max; i++) {
                ...
                source = "image/gp.png";
                mf_amount = 35;
                namegoogle = items[i].displayName;
